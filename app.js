...
const i18n = {
  tr: {
    ...
    "navContact": "İletişim",
    "introBadge": "ESOGÜ Endüstri Mühendisliği · AEON LLC (Delaware) · Yazılım Geliştirici & Kurucu",
    "introHeading": "Fikirden Canlı Sisteme:<br><span class=\"text-gradient\">Yüksek Kaldıraçlı</span> Dijital Yazılım ve Sistemler",
    "introBio": "Geleneksel ajansların ve kalabalık ekiplerin aylar harcadığı dijital ürünleri; lüks butik otel ERP omurgalarından uçta çalışan bilgisayarlı görü sistemlerine, mağazada canlı mobil uygulamalardan programatik medya motorlarına kadar tek çatı altında, yüksek hız ve tam döngü (full-cycle) mühendislik disipliniyle inşa ediyorum.",
    "btnExplore": "Projeleri İnceleyin",
    "btnViewCv": "Özgeçmiş & Kariyer",
    "btnPdfCv": "PDF Olarak Kaydet",
    "contactRoleLbl": "Rol & Konum:",
    "pPrinciple1": "<strong>Sıfır Koordinasyon Sürtünmesi:</strong> Tasarım, veritabanı, mobil ve bulut tek elden.",
    "pPrinciple2": "<strong>Çalışan MVP Hızı:</strong> 2-4 haftada sahada test edilmiş canlı teslimat.",
    "pPrinciple3": "<strong>Sermaye Kaldıracı:</strong> Yüksek ajans yakım maliyetlerini sıfırlayan doğrudan üretim.",
    "expEyebrow": "Profesyonel Kronoloji",
    "expTitle": "Kariyer & <span>Çalışma Geçmişi</span>",
    "expSubtitle": "Geliştirilen işletme sistemleri, bağımsız girişimler ve uçtan uca mühendislik sorumlulukları.",
    ...
    "contactCardTitle": "Canlı Demo ve Ortaklık Görüşmesi İçin İletişime Geçin",
    "contactCardDesc": "Görüşmede doğrudan canlı projeler (Vent App, AEON ERP, RetailPulse AI) üzerinden sistem mimarilerini canlı demo yapmaya hazırım.",
  ...
  en: {
    ...
    "btnPrintCv": "Print CV",
    "navContact": "Contact",
    "introBadge": "Industrial Engineering (ESOGU) · AEON LLC (Delaware) · Software Developer & Founder",
    "introHeading": "From Concept to Production:<br><span class=\"text-gradient\">High-Leverage</span> Digital Software & Systems",
    "introBio": "Building digital systems that traditional agencies and large teams take months to deliver. From enterprise boutique hospitality ERP backbones and on-prem computer vision pipelines to live consumer mobile apps and programmatic video engines — built with high velocity under full-cycle engineering discipline.",
    "btnExplore": "Explore Projects",
    "btnViewCv": "CV & Career History",
    "btnPdfCv": "Save as PDF",
    "contactRoleLbl": "Role & Location:",
    "pPrinciple1": "<strong>Zero Coordination Friction:</strong> Design, database, mobile, and cloud delivered single-handedly.",
    "pPrinciple2": "<strong>Production MVP Speed:</strong> Field-tested live deliverables deployed in 2-4 weeks.",
    "pPrinciple3": "<strong>Capital Leverage:</strong> Direct engineering execution replacing high agency cash burn.",
    "expEyebrow": "Professional Chronology",
    "expTitle": "Career & <span>Track Record</span>",
    "expSubtitle": "Enterprise systems built, independent ventures founded, and end-to-end engineering deliverables.",
