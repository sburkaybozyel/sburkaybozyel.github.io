...
const i18n = {
  tr: {
    ...
    "introBio": "Eskişehir Osmangazi Üniversitesi Endüstri Mühendisliği öğrencisi. Lüks butik otel ERP omurgalarından uçta çalışan bilgisayarlı görü sistemlerine ve mağazada canlı mobil uygulamalara kadar tam döngü sistemler geliştiriyorum.",
  ...
  en: {
    ...
    "introBio": "Industrial Engineering student at ESOGU. Developing full-cycle software architectures from boutique hospitality ERP backbones and on-prem computer vision systems to live consumer mobile apps.",
