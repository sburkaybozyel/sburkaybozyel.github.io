...
const i18n = {
  tr: {
    ...
    "pPrinciple1": "<strong>Uçtan Uca Sistem Mimarisi:</strong> Mobil uygulama (Flutter), dağıtık veritabanları, API ve bulut altyapısında tam döngü mühendislik.",
    "pPrinciple2": "<strong>Uçta Yapay Zekâ & Bilgisayarlı Görü:</strong> Nvidia Jetson donanımlarında sıfır gecikmeli, %100 yerel ve gizlilik odaklı derin öğrenme hatları.",
    "pPrinciple3": "<strong>Endüstriyel Optimizasyon & Süreç Zekâsı:</strong> ESOGÜ Endüstri Mühendisliği temelleriyle operasyonel darboğazları çözen yüksek verimli sistemler.",
  ...
  en: {
    ...
    "pPrinciple1": "<strong>End-to-End Systems Architecture:</strong> Full-cycle engineering across mobile apps (Flutter), distributed databases, APIs, and cloud infrastructure.",
    "pPrinciple2": "<strong>Edge AI & Computer Vision:</strong> Zero-latency, 100% on-prem deep learning pipelines deployed on Nvidia Jetson hardware.",
    "pPrinciple3": "<strong>Industrial Optimization & Systems Logic:</strong> High-efficiency operational software eliminating bottlenecks via industrial engineering principles.",
