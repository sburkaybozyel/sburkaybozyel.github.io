...
const i18n = {
  tr: {
    ...
    "introHeading": "Uçtan Uca Yazılım &<br><span>Edge AI Sistemleri</span>",
    "introBio": "Lüks otel ERP'lerinden yerel bilgisayarlı görü hatlarına ve mağazada canlı mobil uygulamalara kadar; yüksek performanslı dijital ürünleri tek elden, tam döngü mühendislik disipliniyle inşa ediyorum.",
  ...
  en: {
    ...
    "introHeading": "End-to-End Software &<br><span>Edge AI Systems</span>",
    "introBio": "From luxury hotel ERP backbones to local computer vision pipelines and live consumer mobile apps — building high-performance digital systems with full-cycle engineering discipline.",
